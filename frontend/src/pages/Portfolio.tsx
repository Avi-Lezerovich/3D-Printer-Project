      ...
      >
        ...
        >
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Storage Status */}
            <motion.div 
              className="relative overflow-hidden text-center p-8 bg-gradient-to-br from-purple-500/10 via-purple-600/5 to-indigo-500/10 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-lg group cursor-pointer"
              whileHover={{ scale: 1.05, y: -5 }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.8, duration: 0.5 }}
            >
              {/* Animated background */}
              <div className="absolute inset-0 bg-gradient-to-br from-purple-400/5 to-indigo-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="relative text-slate-200 text-xl font-semibold mb-2">Storage Used</div>
              <div className="relative text-slate-400 text-base">of 5TB available</div>
              ...
              {/* Decorative data icon */}
              <div className="absolute top-4 right-4 w-3 h-3 bg-purple-400 rounded-full animate-bounce" style={{ animationDelay: "0.5s" }}></div>
            </motion.div>
          </div>
          
          {/* Decorative gradient overlay */}
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-blue-500/5 via-purple-500/5 to-transparent rounded-full blur-3xl -translate-x-32 translate-y-32"></div>
        </motion.div>
      </motion.div>
    </div>
  );
